...
public class WeeklyTask extends DailyPlanner {
    public WeeklyTask(Repeatability repeatability, Type type, String title, String description, LocalDateTime executionDateTime) {
    ...
    public boolean appearsIn(LocalDateTime localDateTime) {
        ...
        while(newExecutionDate.isBefore(currentDate) || newExecutionDate.isEqual(currentDate)) {
            newExecutionDate = executionDate.plusWeeks(i);
            i++;
        }
